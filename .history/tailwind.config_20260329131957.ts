...
const config = {
  ...
  plugins: [animatePlugin,addVariablesForColors,function ({ matchUtilities, theme }: { matchUtilities: (utilities: Record<string, (value: string) => Record<string, unknown>>, options: Record<string, unknown>) => void; theme: (path: string) => Record<string, string> }) {
      matchUtilities(
        {
