...
import type { MatchUtilities, Theme } from "tailwindcss/types";
...
const config = {
  ...
  plugins: [animatePlugin,addVariablesForColors,function ({ matchUtilities, theme }: { matchUtilities: MatchUtilities; theme: Theme }) {
      matchUtilities(
        {
